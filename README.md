...
Download [flatpak file x86-64](https://github.com/r-sergii/r-sergii.github.io/releases/download/0.0.1/io.github.r_sergii.WordInPictureNextIt.flatpak)

<p align="center">
<a href="https://github.com/r-sergii/r-sergii.github.io/releases/download/0.0.1/io.github.r_sergii.WordInPictureNextIt.flatpak">
...
```bash
flatpak install --user io.github.r_sergii.WordInPictureNextIt.flatpak
```
...
```bash
flatpak list --app | grep io.github.r_sergii.WordInPictureNextIt
```
...
```bash
flatpak run io.github.r_sergii.WordInPictureNextIt
```

## Remove

```bash
flatpak remove io.github.r_sergii.WordInPictureNextIt
```
