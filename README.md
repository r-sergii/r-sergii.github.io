...
## Description
## Test your knowledge of Afrikaans
...
Download [flatpak file x86-64](https://github.com/r-sergii/r-sergii.github.io/releases/download/0.0.1/io.github.r_sergii.WordInPictureNextAf.flatpak)

<p align="center">
<a href="https://github.com/r-sergii/r-sergii.github.io/releases/download/0.0.1/io.github.r_sergii.WordInPictureNextAf.flatpak">
...
```bash
flatpak install --user io.github.r_sergii.WordInPictureNextAf.flatpak
```
...
```bash
flatpak list --app | grep io.github.r_sergii.WordInPictureNextAf
```
...
```bash
flatpak run io.github.r_sergii.WordInPictureNextAf
```

## Remove

```bash
flatpak remove io.github.r_sergii.WordInPictureNextAf
```
