...
Download [flatpak file x86-64](https://github.com/r-sergii/r-sergii.github.io/releases/download/0.0.1/io.github.r_sergii.WordInPictureNextDe.flatpak)

<p align="center">
<a href="https://github.com/r-sergii/r-sergii.github.io/releases/download/0.0.1/io.github.r_sergii.WordInPictureNextDe.flatpak">
...
```bash
flatpak install --user io.github.r_sergii.WordInPictureNextDe.flatpak
```
...
```bash
flatpak list --app | grep io.github.r_sergii.WordInPictureNextDe
```
...
```bash
flatpak run io.github.r_sergii.WordInPictureNextDe
```

## Remove

```bash
flatpak remove io.github.r_sergii.WordInPictureNextDe
```
